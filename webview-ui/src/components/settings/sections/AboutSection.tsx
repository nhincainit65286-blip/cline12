		...
		<div>
			...
			<Section>
				<div className="flex px-4 flex-col gap-2">
					...
					<h3 className="text-md font-semibold">{t("settings.communitySupport")}</h3>
					<p>
					...
					<h3 className="text-md font-semibold">{t("settings.development")}</h3>
					<p>
						<VSCodeLink href="https://github.com/cline/cline">GitHub</VSCodeLink>
						{" • "}
						<VSCodeLink href="https://github.com/cline/cline/issues"> {t("settings.issues")}</VSCodeLink>
						{" • "}
					...
					<h3 className="text-md font-semibold">{t("settings.resources")}</h3>
					<p>
						<VSCodeLink href="https://docs.cline.bot/getting-started/for-new-coders">{t("settings.documentation")}</VSCodeLink>
						{" • "}
